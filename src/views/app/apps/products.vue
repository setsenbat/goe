<template>
  <div class="main-content">
    ...
    <b-container class="mb-30">
      <b-row>
        <b-col>
          <b-form-input style="border: 4px solid #f97316;
  border-radius: 0; height: 3rem;" v-model="search" type="text" :placeholder="$t('search')"></b-form-input>
        </b-col>
      </b-row>
    </b-container>
    <b-row>
    ...
    >
        ...
        <div class="list-thumb d-flex">
          <img alt :src='require("@/assets/images/goe/poster1.jpg")' />
        </div>
    </b-card>
    </b-col>
      ...
      <b-col lg="3" md="6" sm="12">
        ...
        >
          ...
          <div class="list-thumb d-flex">
          <img alt :src='require("@/assets/images/goe/poster2.jpg")' />
        </div>
        </b-card>
      </b-col>
      ...
      <b-col lg="3" md="6" sm="12">
        ...
        >
        <div class="list-thumb d-flex">
          <img alt :src='require("@/assets/images/goe/poster3.jpg")' />
        </div>
        </b-card>
      </b-col>
      <b-col lg="3" md="6" sm="12">
        ...
        >
        <div class="list-thumb d-flex">
          <img alt :src='require("@/assets/images/goe/poster4.jpg")' />
        </div>
        </b-card>
      </b-col>
    </b-row>
